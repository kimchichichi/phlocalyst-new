...
| `Music.html`, `About.html`, `Contact.html`, `Shows.html` | Secondary pages; share `contact.css` for nav/layout |
| `contact.css` | Shared stylesheet for the secondary pages |
...
The secondary pages (`Music.html`, `About.html`, `Contact.html`, `Shows.html`) also default to the `midnight` theme and do not include the tweaks panel.
